...
internal static class WithPropertyHandler
{
		...
		foreach (var typeGroup in values.GroupBy(static r => r.TypeSymbol))
		{
			...
			result.Add(
				...
				namespace {{namespaceString["global::".Length..]}}
				{
					...
					[global::System.CodeDom.Compiler.GeneratedCodeAttribute("{{typeof(WithPropertyHandler).FullName}}", "{{Value}}")]
					[global::System.Runtime.CompilerServices.CompilerGeneratedAttribute]
					public static partial class __{{typeSymbol.Name}}FactoryMethods_With
					{
				{{string.Join("\r\n\r\n\t\t", methodDeclarations)}}
					}
				}
